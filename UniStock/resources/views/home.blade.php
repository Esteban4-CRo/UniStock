                ...
                <table class="table" style="color: #fff;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm mb-1" href="{{ route('entradas.create') }}?producto_id={{ $p->id }}">Entrada</a>
                                <a class="btn btn-danger btn-sm mb-1" href="{{ route('salidas.create') }}?producto_id={{ $p->id }}">Salida</a>
                            </td>
                        </tr>
                        @endforeach
                     </tbody>
