...
<head>
    ...
    <title>Nueva Salida - UniStock</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stock-info { background: #ffeaea; padding: 0.5rem; border-radius: 4px; margin-top: 0.5rem; }
    </style>
</head>
<body>
    <nav class="navbar">
    ...
    <div class="container">
        <div class="card">
            <h1 style="margin-bottom: 2rem;">Registrar Salida de Inventario</h1>
            ...
            <form action="{{ route('salidas.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div id="stock-warning" class="stock-info" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <textarea id="motivo" name="motivo" rows="3" placeholder="Ej: Venta, Uso interno, Pérdida...">{{ old('motivo') }}</textarea>
